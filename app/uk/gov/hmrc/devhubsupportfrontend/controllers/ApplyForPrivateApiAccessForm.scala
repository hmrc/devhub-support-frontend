...
final case class ApplyForPrivateApiAccessForm(fullName: String, emailAddress: String, organisation: String, privateApi: String, applicationId: String, url: Option[String])
