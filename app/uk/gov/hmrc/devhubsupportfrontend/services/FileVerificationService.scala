...
import uk.gov.hmrc.devhubsupportfrontend.domain.models.upscan.{FileUploadContext, FileVerificationStatus, JourneyId}

import javax.inject.Inject
import scala.concurrent.Future

class FileVerificationService @Inject()(fileUploadService: FileUploadService) extends ApplicationLogger {
